...
Ext.define('CWIC.controller.home', {
    ...
    onButtonTap: function(button, e, eOpts) {
        ...
        else if (button.config.itemId === "mapsButton") 
		{
            ...
            fieldGuide.down('#maps').setHtml("<div id='search' style='position:absolute; display:block; top:20px; zIndex: 2; left:74px;'></div><div id='mapDiv' style='position:absolute; height:100%; width:100%;'></div>");
            ...
            function (Map, ArcGISTiledMapServiceLayer, ImageParameters, QueryTask, Query, Search) {
	  ...
	  var geo = e.results[0][0].feature.geometry;
...
function geoCallBack(position)
{
	...
	//RSF team added code below to get some geo functionality for IOS devices 03/06/16
...
// navigator.geolocation.getCurrentPosition(geoCallBack, geoCallBack);       
 
                    
            Ext.Msg.alert('GPS', 'Sorry we were unable to find your location using your gps.  If you have an internet connection, you can click the search location button to search for a location.', Ext.emptyFn);
